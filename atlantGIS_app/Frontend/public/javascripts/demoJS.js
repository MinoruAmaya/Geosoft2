...
window.onload = function () {//  w w w  . j  ava  2 s  .c  o m
    ...
    btn.addEventListener("click", function(){addPredictionAndAoaToMap("http://localhost:4000/database/data/demo/Klassifikation_muenster.tif"/*, "http://localhost:4000/database/data/demo/AOA_muenster.tif"*/)});
