...
calculateAoA <- function() {
    ...
    # Sentinel einladen
    sentinel <- stack("./public/data/satelliteimagery/satelliteimage.tif")

    # Model einladen
    trainedModel <- get(load("./public/data/model/model.RDS"))
    ...
    tmap_save(map, "./public/data/output/AoA.png")
    return("success")
}
